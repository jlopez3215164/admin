...
<div id="invoice-preview">
   ...
   <script>
      function printFiscal(id) {
         ...
         $.ajax({
            type: "GET",
            url: admin_url + "invoices/printFiscal/" + id,
      ...
      function printCreditNoteFiscal(id) {
         ...
         $.ajax({
            type: "GET",
            url: admin_url + "invoices/printCreditNoteFiscal/" + id,
            success: function (data) {
         ...
         <?php if ($invoice->is_print_fiscal == NULL) { ?>
            <div class="col-md-3">
               <button style='margin-top:0px;width: 100%;' onclick="printFiscal(<?php echo $invoice->id; ?>)"
                  class="btn btn-success">FACTURA FISCAL</button>
            </div>
         <?php } ?>
         <?php if (isset($invoice->bill_number) && $invoice->is_print_fiscal == 2) { ?>
            <div class="col-md-3">
               <button style='margin-top:0px;width: 100%;' onclick="printCreditNoteFiscal(<?php echo $invoice->id; ?>)"
                  class="btn btn-warning">NOTA DE CREDITO</button>
            </div>
         <?php } ?>
      <?php } ?>
      <div class="col-md-3">
         <button style='margin-top:0px;width: 100%;' onclick="printNoFiscal(<?php echo $invoice->id; ?>)"
            class="btn btn-info">NOTA DE ENTREGA</button>
      </div>
      <div class="col-md-3">
         <button style='margin-top:0px;width: 100%;' onclick="deleteBillFinal(<?php echo $invoice->id; ?>)"
