...
$lang['is_referenced']        = 'El ID de la %s ya está utilizando.'; PREGUNTAR
...
$lang['cant_delete_default']  = 'No puedo eliminar el %s por defecto'; No se puede borrar por defecto

# Invoice general

$lang['invoice_status_paid']                   = 'Estatus de la factura pagado';

$lang['invoice_status_unpaid']                 = 'Estatus de la factura s';

$lang['invoice_status_overdue']                = 'Estatus de la factura vencida';

$lang['invoice_status_not_paid_completely']    = 'Estatus de la factura pagada parcialmente';

$lang['invoice_pdf_heading']                   = 'FACTURA'; (PREGUNTAR)
...
$lang['invoice_payments_table_date_heading']   = 'Fecha de pago';

$lang['invoice_payments_table_amount_heading'] = 'Monto'; *
...
$lang['client_vat_number']                       = 'NIF'; (PREGUNTAR)
...
$lang['client_password_last_changed']            = 'Último cambio de la contraseña del cliente:';
...
$lang['clients_list_last_login']                 = 'Último inicio de sesión'; *
...
$lang['contract_end_date']        = 'Fecha de terminación';

$lang['contract_subject']         = 'Objeto'; *

$lang['contract_description']     = 'Descripción';

$lang['contract_subject_tooltip'] = 'Tema también es visible para el cliente.'; Información sobre el objeto del contrato (PREGUNTAR)

$lang['contract_client_string']   = 'Cadena de clientes por contrato'; *

$lang['contract_attach']          = 'Contrato adjunto'; *

$lang['contract_list_client']     = 'Cliente';

$lang['contract_list_subject']    = 'Objeto'; *

$lang['contract_list_start_date'] = 'Fecha de inicio';

$lang['contract_list_end_date']   = 'Fecha de terminación'; *
...
$lang['make_base_currency']            = 'Hacer moneda base'; establecer moneda base (PREGUNTAR) *

$lang['base_currency_string']          = 'Cadena de moneda base'; *

$lang['currency_list_name']            = 'Nombre';

$lang['currency_list_symbol']          = 'Símbolo';

$lang['currency_add_edit_description'] = 'Nombre de la moneda'; Añadir moneda editar descripción (PREGUNTAR) *

$lang['currency_add_edit_rate']        = 'Tasa';

$lang['currency_edit_heading']         = 'Cambiar la moneda'; (PREGUNTAR)
...
$lang['department_list_name']        = 'Nombre de la lista de departamentos'; *
...
$lang['template_fromemail']                     = 'De: email';*

$lang['send_as_plain_text']                     = 'Enviar como texto simple'; * 

$lang['email_template_disabled']                = 'plantilla de correo electrónico desactivada'; *

$lang['email_template_email_message']           = 'Mensaje de email'; (PREGUNTAR)
...
$lang['create_recurring_from_child_error_message'] = 'You cannot set this %s as recurring because this %s is child from another recurring %s.';
													  "No puede establecerlo como recurrente porque es hijo de otro recurrente" (Preguntar) 

$lang['statement_credit_note_refund']              = 'Credit Note Refund - %s'; Reembolso de nota de crédito.

$lang['no_validation']                             = 'No Validation'; Sin validación.

$lang['lead_unique_validation_on']                 = 'Perform validation for duplicate lead on the following fields:'; Realice la validación de duplicados en los siguientes campos.

$lang['phonenumber_exists']                        = 'Phone number already exists'; El número de teléfono ya existe.

$lang['company_exists']                            = 'Company already exists'; La compañía ya existe.

$lang['website_exists']                            = 'Website already exists'; La página web ya existe.

$lang['send_payment_receipt_to_client']            = 'Send Payment Receipt To Client'; Enviar recibo de pago al cliente.

$lang['payment_sent_successfully']                 = 'Payment receipt sent successfully.'; Recibo de pago enviado con éxito.

$lang['payment_sent_failed']                       = 'Failed to send payment receipt.'; Error en el envío del recibo de pago.



# Version 2.3.5

$lang['tags_update_replace_warning'] = 'Some tags are not updated because the name of the tag already exist'; Algunas etiquetas no se han actualizado porque el nombre de la etiqueta ya existe

$lang['attach_statement']            = 'Attach Customer Statement'; Adjuntar comunicado del cliente



# Version 2.4.0

$lang['delete_credit_card']               = 'Delete Card'; Eliminar tarjeta

$lang['delete_credit_card_info']          = 'You cannot delete the credit card as you have active subscriptions.'; No puede eliminar la tarjeta de crédito ya que tiene suscripciones activas.

$lang['credit_card_successfully_deleted'] = 'Credit card successfully deleted.'; Tarjeta de crédito eliminada con éxito.

$lang['subscription_incomplete']          = 'Incomplete'; Incompleto

$lang['subscription_incomplete_expired']  = 'Incomplete Expired'; Incompleto Expirado

$lang['credit_card_short']                = 'Card'; Tarjeta

$lang['webhook_created']                  = 'Webhook created successfully.'; El enlace web se ha creado con éxito.

$lang['subscriptions_terms_info']         = 'Enter customer terms & conditions to be displayed to the customer before subscribe to the subscription.'; Introduzca los términos y condiciones que se mostrarán al cliente antes de suscribirse.

$lang['subscription_complete_payment']    = 'Complete Payment'; Pago completo (Completar pago)

$lang['subscription_is_subscription_is_expired'] = 'This subscription is expired.'; Esta suscripción ha caducado/expirado.

$lang['subscription_plan_currency_does_not_match'] = 'Selected plan currency does not match currency selected below.'; La moneda seleccionada para el plan no coincide con la moneda seleccionada a continuación.

$lang['subscription_first_billing_date_info'] = 'Déjelo en blanco para utilizar la fecha en la que el cliente se haya subscrito a la suscripción. Este campo debe ser una fecha futura, si selecciona la fecha y la fecha ya pasó pero el cliente aún no está suscrito, se utilizará la fecha en que el cliente se vaya a suscribir.';
...
$lang['stripe_subscription_select_plan'] = 'Select Stripe plan'; Seleccione el plan Stripe (PREGUNTAR)



# Version 2.4.1

$lang['contract_content_permission_edit_warning'] = 'Your current permissions does not allows you to edit the contract content. Consult with an administrator to allow you permission to edit contracts.';
													 Sus permisos actuales no le permiten editar el contenido del contrato. Consulte con un administrador para que le autorice la edición de los contratos.

$lang['mark_as_signed']                 = 'Marcar como firmado'; //Marcar como firmado //Mark as signed

$lang['unmark_as_signed']               = 'Unmark as signed'; Desmarcar como firmado

$lang['marked_as_signed']               = 'Marked as signed'; Marcado como firmado

$lang['contract_marked_as_signed_info'] = 'This contract is manually marked as signed.'; Este contrato está marcado manualmente como firmado.

$lang['save_and_send_later']            = 'Save and Send Later'; Guardar y enviar más tarde

$lang['schedule']                       = 'Schedule'; Programar
 
$lang['schedule_email_for']             = 'Schedule Email for %s'; Programar correo electrónico para %s

$lang['schedule_date']                  = 'When would you like to send the email?'; ¿Cuándo desea enviar el correo electrónico?

$lang['email_scheduled_successfully']   = 'Email scheduled successfully'; Correo electrónico programado con éxito

$lang['invoice_will_be_sent_at']        = 'Invoice will be sent at %s'; La factura se enviará a %s



# Version 2.5.0

$lang['recaptcha_ignore_ips']               = 'Ignored IP Addresses'; Direcciones IP ignoradas

$lang['recaptcha_ignore_ips_info']          = 'Enter coma separated IP addresses that you want the reCaptcha to skip validation.'; Introduzca las direcciones IP separadas por comas que desea que el reCaptcha omita la validación.

$lang['show_task_reminders_on_calendar']    = 'Task Reminders'; Recordatorios de tareas

$lang['contracts_about_to_expire']          = 'Contracts Expiring Soon'; Contratos que expiran pronto

$lang['no_contracts_about_to_expire']       = 'There are no contracts that are going to expire in the next %s days.'; No hay contratos que vayan a expirar en los próximos %s días.

$lang['lead_value']                         = 'Lead value'; Valor líder

$lang['lead_value_tooltip']                 = 'Base currency will be used.'; Se utilizará la moneda base.

$lang['leads_dt_lead_value']                = 'Lead Value'; Valor líder

$lang['leads_canban_lead_value']            = 'Lead Value: %s'; Valor líder: %s

$lang['lead_add_edit_lead_value']           = 'Lead Value'; Valor líder



# Version 2.6.0

$lang['gantt_view_day'] = 'Days View'; Mostrar Días/Vista de los días

$lang['gantt_view_week'] = 'Weeks View'; Mostrar Semanas/Vista de las semanas

$lang['gantt_view_month'] = 'Months View'; Mostrar Meses/Vista de los meses

$lang['gantt_view_year'] = 'Years View'; Mostrar Años/Vista de los años



# Version 2.7.0

$lang['hour_of_day_perform_tasks_reminder_notification_help'] = '24 hours format eq. 9 for 9am or 15 for 3pm. It is used for recurring Task, Task reminders etc.'; Formato de 24 horas eq. 9 para 9am o 15 para 3pm. Se utiliza para tareas recurrentes, recordatorios de tareas, etc.

$lang['clients_nav_contacts']                                 = 'Contacts'; Contactos

$lang['clients_my_contacts']                                  = 'Contacts'; Contactos

$lang['clients_my_contact']                                   = 'Contact'; Contacto

$lang['new_contact']                                          = 'New Contact'; Nuevo Contacto

$lang['customer_contact']                                     = 'My Contacts'; Mis Contactos

$lang['clients_contact_added']                                = 'Contact added successfuly'; Contrato agregado exitosamente

$lang['clients_contact_updated']                              = 'Contact updated successfuly'; Contacto acutalizado exitosamente

$lang['allow_primary_contact_to_manage_other_contacts']       = 'Allow primary contact to manage other customer contacts'; Permitir que el contacto principal gestione los contactos de otros clientes

$lang['contact_form_validation_is_unique']                    = 'Contact with this {field} already exists in our system'; El contacto con este {campo} ya existe en nuestro sistema
...
$lang['invoice_number_not_applied_on_draft']                  = 'If the invoice is saved as draft, the number won\'t be applied, instead, the next invoice number will be given when the invoice is sent to the customer or is marked as sent.';
																 Si la factura se guarda como borrador, el número no se aplicará, en cambio, el siguiente número de factura se dará cuando la factura se envíe al cliente o se marque como enviada.



$lang['two_factor_authentication_disabed']                    = 'Disabled'; Desactivado

$lang['enable_google_two_factor_authentication']              = 'Enable Google Authenticator'; Activar el Autenticador de Google

$lang['set_google_two_factor_authentication_failed']          = 'Saving authentication failed, please try again'; Error en guardar la autenticación, por favor, inténtelo de nuevo

$lang['enter_two_factor_auth_code_from_mobile']               = 'Enter authentication code from the Authenticator app'; Introduzca el código de autenticación desde la aplicación Authenticator

$lang['staff_two_factor_authentication']                      = 'Two Factor Authentication'; Doble Autenticación

$lang['google_authentication_code']                           = 'Enter code from Authenticator app'; Introduzca el código de la aplicación Authenticator

$lang['set_two_factor_authentication_successful']             = 'Successfully updated two factor authentication settings'; Se ha actualizado con éxito la configuración de la autenticación de dos pasos

$lang['set_two_factor_authentication_failed']                 = 'Could not update two factor authentication settings'; No se ha podido actualizar la configuración de la autenticación de dos pasos

$lang['google_2fa_code_valid']                                = 'Successfuly verified the authentication'; Se ha verificado con éxito la autenticación

$lang['google_2fa_code_invalid']                              = 'Invalid authentication code entered, try again.'; Código de autenticación introducido inválido, inténtelo de nuevo.
...
$lang['google_2fa_scan_qr_guide']                             = 'Scan the QR below with the Google Authenticator app on your mobile device, after that fill in the field below with the code generated in the app'; 
																  Escanee el código QR que aparece a continuación con la aplicación Google Authenticator en su dispositivo móvil y, a continuación, rellene el campo siguiente con el código generado en la aplicación

$lang['google_2fa_manul_input_secret']                        = 'Secret key for manual input'; Clave secreta para la introducción manual
...
$lang['add_template']                                = 'Add Template'; Agregar Plantilla

$lang['edit_template']                               = 'Edit Template'; Editar Plantilla

$lang['template_added']                              = 'Template added successfully'; Plantilla agregada exitosamente

$lang['template_updated']                            = 'Template updated successfully'; Plantilla actualizada exitosamente

$lang['template_name']                               = 'Template Title'; Titulo de Plantilla

$lang['template_content']                            = 'Template Content'; Contenido de Plantilla

$lang['insert_template']                             = 'Insert'; Insertar

$lang['items_table_amounts_exclude_currency_symbol'] = 'Exclude currency symbol from items table Amount'; Excluir el símbolo de la divisa de los artículos de la tabla de Montos



$lang['multiplies_of']               = 'Multiplies of'; Mùltiplos de

$lang['round_off_task_timer_option'] = 'Round off task timer'; Redondear el temporizador de tareas

$lang['task_timer_dont_round_off']   = 'Don\'t round off'; No redondear

$lang['task_timer_round_up']         = 'Round up'; Redondear

$lang['task_timer_round_down']       = 'Round down'; Redondear hacia abajo

$lang['task_timer_round_nearest']    = 'Round to nearest'; Redondear al número/valor más cercano (REVISAR)

$lang['calendar_task_reminder']      = 'Task Reminder'; Recordatorio de tareas

$lang['projects_chart']              = 'Projects Chart'; Gráfico de proyectos

$lang['overdue_by_days']             = 'OVERDUE BY %s DAYS'; CON UN RETRASO DE ___ DÍAS



$lang['two_checkout_payment_processing'] = 'Payment is been processed, you will be notified if successful'; El pago ha sido procesado, será notificado si es exitoso

$lang['two_checkout_payment_cancelled']  = 'Payment Cancelled'; Pago cancelado

$lang['two_checkout_merchant_code']      = 'Merchant Code'; Código de comerciante/comercio (REVISAR)

$lang['two_checkout_secret_Key']         = 'Secret Code'; Código secreto

$lang['two_gateway_webhook_notice']      = 'The IPN Endpoint for 2Checkout is ( %s )'; El punto final de IPN para 2 compras es ( %s )

$lang['something_went_wrong']            = 'Something went wrong. Try again'; Algo ha salido mal. Inténtalo de nuevo

$lang['imap_folder']                     = 'Folder'; Carpeta

$lang['retrieve_folders']                = 'Retrieve Folders'; Recuperar carpetas

$lang['email_to_ticket_config']          = 'Email to ticket configuration'; Correo electrónico para la configuración del ticket (PREGUNTAR)
...
$lang['enable_support_menu_badges']     = 'Enable support menu item badge'; Habilitar símbolo del menú de soporte

$lang['item_copy_success']              = 'Item copied successfully'; Elemento copiado con éxito

$lang['item_copy_fail']                 = 'Failed to copy item'; Error al copiar un elemento

$lang['attach_invoice_to_payment_receipt_email'] = 'Attach invoice PDF when sending payment receipt to email'; Adjuntar la factura en PDF al enviar el recibo de pago por correo electrónico



$lang['estimate_request']                       = 'Estimate request'; Solicitud de presupuesto

$lang['estimate_requests']                      = 'Estimate request'; Solicitud de presupuesto

$lang['estimate_request_form']                  = 'Estimate request form'; Formulario de solicitud de presupuesto

$lang['acs_estimate_request']                   = 'Estimate request'; Solicitud de presupuesto

$lang['acs_estimate_request_forms']             = 'Forms'; Formulario

$lang['estimate_request_forms']             = 'Estimate Request Forms'; Formularios de solicitud de presupuesto

$lang['estimate_request_notify_staff']          = 'Staff Members to Notify'; Miembros del personal a notificar

$lang['estimate_request_notify_when_submitted']     = 'Notify when estimate request submitted'; Notificar la presentación de una solicitud de presupuesto

$lang['estimate_request_assignee']              = 'Responsible (Assignee)'; Responsable (Asignado)

$lang['estimate_request_notify_roles']          = 'Roles to Notify'; Funciones a notificar
 
$lang['custom_field_estimate_request']          = 'Estimate request'; Solicitud de presupuesto

$lang['new_estimate_request_submitted_from_form']     = 'New Estimate Request submitted from Form - %s'; Nueva solicitud de presupuesto enviada desde el formulario ____

$lang['acs_estimate_request_statuses_submenu']  = 'Statuses'; Estatus

$lang['estimate_request_dt_email']              = 'Email'; Correo electrónico

$lang['estimate_request_dt_assigned']           = 'Assigned'; Asignado

$lang['estimate_request_dt_status']             = 'Status'; Estatus

$lang['estimate_request_dt_datecreated']        = 'Created'; Creado

$lang['estimate_request_attachments']           = 'Attachments'; Anexos

$lang['estimate_request_new_status']            = 'New Status'; Nuevo estatus

$lang['estimate_request_status_table_name']     = 'Status Name'; Nombre del estatus

$lang['estimate_request_table_total']           = 'Total Request: %s'; Total de solicitudes: %s".
 
$lang['estimate_request_statuses_not_found']    = 'No Estimate Request statuses found'; No se ha encontrado ningún estatus de solicitud de presupuesto

$lang['estimate_request_status_add_edit_name']  = 'Status Name'; Nombre del estatus

$lang['estimate_request_status_color']          = 'Color'; Color

$lang['estimate_request_status_add_edit_order'] = 'Status Order'; Estado de la orden

$lang['estimate_request_status']                = 'Status'; Estatus/Estado

$lang['estimate_request_date_added']            = 'Date Created'; Fecha de creación/elaboración (revisar)

$lang['estmate_request_tags_updated']           = 'Tags Updated'; Etiquetas Actualizadas

$lang['not_estimate_request_activity_status_updated'] = '%s updated estimate request status from %s to %s'; ___ actualizar el estado de la solicitud de presupuesto de %s a %s

$lang['estimate_request_lowercase']             = 'estimate request'; solicitud de presupuesto

$lang['estimate_request_form_email_field_is_required']     = 'Email field is required to be added on the form'; Es necesario añadir el campo de correo electrónico en el formulario

$lang['estimate_request_form_email_field_set_to_required'] = 'Mark the email field as required'; Marque el campo de correo electrónico como obligatorio

$lang['not_delete_estimate_request_default_status']        = 'Cannot delete core estimate request status'; No se puede eliminar el estado de la solicitud de presupuesto del núcleo (PREGUNTAR)

$lang['mark_estimate_request_as']               = 'Mark as %s'; Marcar como ___

$lang['estimate_request_updated']              = 'Estimate Request Updated'; Solicitud de presupuesto actualizada

$lang['convert_estimate_request']               = 'Convert Estimate Request'; Convertir solicitud de presupuesto

$lang['estimate_request_client_firstname']      = 'First Name'; Primer Nombre

$lang['estimate_request_client_lastname']       = 'Last Name'; Apellido

$lang['estimate_request_email']                 = 'Email'; Correo Electrónico

$lang['estimate_request_for_lead']              = 'Lead'; Guía (PREGUNTAR)

$lang['estimate_request_for_customer']          = 'Customer'; Cliente

$lang['estimate_request_related']               = 'Related to'; Relacionado con

$lang['estimate_request_client_created_success'] = 'Estimate Request Customer Created'; Solicitud de presupuesto Cliente creado (PREGUNTAR)

$lang['estimate_request_assigned']              = 'Staff Assigned'; Personal Asignado

$lang['not_estimate_request_activity_assigned_updated']       = 'Estimate Request Assigned to %s'; Solicitud de presupuesto asignado a %s

$lang['estimate_request_status_lowercase']      = 'estimate request status'; estado de la solicitud de presupuesto

$lang['estimate_request_assigned_to_staff']     = 'Estimate Request has been assigned to you'; Se le ha asignado una solicitud de presupuesto



$lang['activity_due_reminder_is_sent']          = '%s sent invoice becoming due reminder'; %s ha enviado una factura que se ha convertido en un recordatorio de vencimiento

$lang['invoice_due_notice_before']              = 'Send due reminder X days before due date'; Enviar recordatorio de vencimiento X días antes de la fecha de vencimiento

$lang['overdue_notices']                        = 'Overdue Notices'; Avisos de vencimiento

$lang['invoice_overdue_notices_info']           = 'Overdue notices are sent when the invoice becomes overdue.'; Los avisos de vencimiento se envían cuando la factura se vence.

$lang['due_reminders']                          = 'Due Reminders'; Recordatorios de vencimiento

$lang['due_reminders_for_invoices_info']        = 'Due reminders are sent to unpaid and partially paid invoices as reminder to the customer to pay the invoice before is due.'; Los recordatorios de vencimiento se envían a las facturas no pagadas y parcialmente pagadas como recordatorio al cliente para el pago de la factura antes de su vencimiento.

$lang['expenses_list_made_payment_by']          = 'Made Payment by %s'; Pago realizado por %s



# Version 2.8.2

$lang['hide_task_checklist_items_completed']          = 'Hide completed items'; Ocultar los elementos completados
 
$lang['show_task_checklist_items_completed']          = 'Show completed items %s'; Mostrar elementos completados %s

$lang['task_checklist_assign']                        = 'Assign staff'; Asignar personal

$lang['task_checklist_assigned']                      = 'Assigned to %s'; Asignado a %s



# Version 2.8.3

$lang['projects_send_contact_notification']                   = 'Send contacts notifications'; Enviar notificaciones a los contactos

$lang['project_send_all_contacts_with_notifications_enabled'] = 'To all contacts with notifications for projects enabled'; A todos los contactos con notificaciones de proyectos activos

$lang['project_do_not_send_contacts_notifications']           = 'Do not send notifications'; No enviar notificaciones

$lang['project_send_specific_contacts_with_notification']     = 'Specific contacts'; Contactos específicos

$lang['project_contacts_to_notify']                           = 'Select contacts to notify'; Seleccionar los contactos a notificar

$lang['contract_signed_by']                                   = 'Signer Name'; Nombre del firmante

$lang['contract_signed_date']                                 = 'Signed Date'; Fecha de la firma

$lang['contract_signed_ip']                                   = 'IP Address'; Dirección IP

$lang['show_estimate_request_in_customers_area']              = 'Show Estimate request link in customers area?'; ¿Mostrar el enlace de solicitud de presupuesto en el área de clientes?

$lang['customers_estimate_request_link_text']                 = 'Request Estimate'; Solicitar presupuesto

$lang['total_expenses_deleted']                               = 'Total Expenses Deleted: %s'; Total de gastos eliminados: %s

$lang['estimate_convert_to_project']                          = 'Convert to Project'; Convertir en proyecto

$lang['estimate_items_convert_to_tasks']                      = 'Items that will be converted to tasks'; Elementos que se convertirán en tareas



# Version 2.9.0

$lang['home_payment_records']                                 = 'Payment Records'; Registros de pagos

$lang['weekly']                                               = 'Weekly'; Semanal

$lang['monthly']                                              = 'Monthly'; Mensual

$lang['failed_to_update_timesheet']                           = 'Timesheet was not updated'; La hoja de tiempo no fue actualizada

$lang['permission_create_timesheets']                         = 'Create Timesheets'; Crear hojas de tiempo (REVISAR)

$lang['permission_edit_timesheets']                           = 'Edit Timesheets (Global)'; Editar hojas de tiempo (global)

$lang['permission_edit_own_timesheets']                       = 'Edit Own Timesheets'; Editar tus hojas de tiempo

$lang['permission_delete_timesheets']                         = 'Delete Timesheets (Global)'; Borrar hojas de tiempo (global)

$lang['permission_delete_own_timesheets']                     = 'Delete own Timesheets'; Borrar tus hojas de tiempo

$lang['permission_edit_milestones']                           = 'Edit Milestones'; Editar objetivos

$lang['permission_delete_milestones']                         = 'Delete Milestonea'; Eliminar objetivos

$lang['add_timesheet'] 										  = 'Add timesheet'; Agregar hoja de tiempo

$lang['submit_button_bg_color']                               = 'Submit button background color'; Color de fondo del botón de envío (PREGUNTAR)

$lang['submit_button_text_color']                             = 'Submit button background text'; Texto de fondo del botón de envío

$lang['automatically_assign_ticket_to_first_staff_responding'] = 'Automatically assign the ticket to the first staff that post a reply?'; ¿Asignar automáticamente el ticket al primer miembro del personal que publique una respuesta?



# Version 2.9.1

$lang['contract_signed_not_all_fields_editable'] = 'This contract is signed, hence not all fields can be edited until the signature is removed.'; Este contrato está firmado, por lo que no pueden editarse todos los campos hasta que se elimine la firma.

$lang['form_submit_success_action']              = 'What should happen after a visitor submits this form'; ¿Qué debería ocurrir después de que un usuario envíe este formulario?

$lang['form_submit_success_display_thank_you']   = 'Display thank you messsage'; Mostrar mensaje de agradecimiento

$lang['form_submit_success_redirect_to_website'] = 'Redirect to another website'; Redirigir a otro sitio web

$lang['form_submit_website_url']                 = 'Website URL'; URL del sitio web



# Version 2.9.2

$lang['open_google_map']                                    = 'Open in Google Map'; Abrir en Google Map

$lang['milestone_start_date']                               = 'Start Date'; Fecha de inicio

$lang['send_reminder_for_completed_but_not_billed_tasks']   = 'Send an email reminder of billable tasks completed but not billed'; Enviar un correo electrónico como recordatorio de las tareas facturables realizadas pero no cobradas

$lang['staff_to_notify_completed_but_not_billed_tasks']     = 'Select which staff members you want to receive the reminder'; Seleccione los miembros del personal que desea que reciban el recordatorio

$lang['reminder_for_completed_but_not_billed_tasks_days']   = 'Select days of the week reminder should be sent'; Seleccione los días de la semana en que debe enviarse el recordatorio

$lang['notifications']                                      = 'Notifications'; Notificaciones
 
$lang['merged']                                             = 'Merged'; Fusionado/Unificado (PREGUNTAR)

$lang['ticket_merged_notice']                               = 'This ticket is merged into the ticket with ID'; Este ticket se ha fusionado con un ticket con ID/Identificación (PREGUNTAR)
 
$lang['view_primary_ticket']                                = 'View primary ticket'; Ver ticket principal

$lang['merge_tickets']                                      = 'Merge Tickets'; Fusionar tickets

$lang['primary_ticket']                                     = 'Primary Ticket'; Ticket Principal

$lang['primary_ticket_status']                              = 'Primary Ticket Status'; Estatus del Ticket Principal

$lang['tickets_merged']                                     = 'Tickets Merged Successfully'; Tickets Fuscionados con Éxito

$lang['cannot_merge_into_merged_ticket']                    = 'Ticket that is merged into another ticket cannot be used as primary ticket'; El ticket que se fusiona con otro ticket no puede ser utilizado como ticket principal

$lang['merge_ticket_ids_field_label']                       = 'Merge Ticket #'; Fusionar Ticket

$lang['merge_ticket_ids_field_placeholder']                 = 'example: 5 or 5,6'; ejemplo: 5 o 5,6

$lang['cannot_merge_tickets_with_ids']                      = 'Ticket %s is already merged in another ticket'; El ticket %s ya está fusionado en otro ticket

$lang['ticket_merged_tickets_header']                       = 'This ticket contains %s tickets that are merged'; Este ticket contiene %s tickets que están fusionados

$lang['batch_payments_table_invoice_number_heading']        = 'Invoice Number'; Número de factura

$lang['batch_payments_table_payment_date_heading']          = 'Payment Date'; Fehca de Pago

$lang['batch_payments_table_payment_mode_heading']          = 'Payment Mode'; Modo de Pago

$lang['batch_payments_table_transaction_id_heading']        = 'Transaction Id'; Id de la Transacción

$lang['batch_payments_table_amount_received_heading']       = 'Amount received'; Monto recibido

$lang['batch_payments_table_invoice_balance_due']           = 'Invoice Balance Due'; Saldo de la factura pendiente

$lang['add_batch_payments']                                 = 'Add Payments'; Agregar Pagos

$lang['batch_payment_filter_by_customer']                   = 'Filter invoices by customer'; Filtrar facturas por cliente

$lang['batch_payments']                                     = 'Batch Payments'; Pagos por lotes

$lang['batch_payment_added_successfully']                   = 'You have successfully added %s payments'; Ha añadido ___ pagos con éxito
 
$lang['batch_payments_send_invoice_payment_recorded']       = 'Do not send invoice payment recorded email to customer contacts'; No enviar el correo electrónico con el registro del pago de la factura a los contactos del cliente

$land['invoice_batch_payments']                             = 'Batch Payment'; Pago por lotes

$lang['staff_is_currently_replying']                        = '%s is currently replying to ticket.'; %s está contestando al ticket. (PREGUNTAR)
